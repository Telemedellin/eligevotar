<div class="wrap bsf-page-wrapper ultimate-about">
	...
	<div class="heading-section">
		<div class="wrap left-content-section">
			...
			<h2><?php echo __('wWw.Null24.IR - Geronimo!','ultimate_vc'); ?></h2>
			<p><?php  _e('wWw.Null24.IR - Ultimate '.ULTIMATE_VERSION.' is installed and you are set to take your website design experience to the next level. - WwW.Null24.IR','ultimate_vc'); ?></p>
...
<div class="bsf-wrap">
	...
	<div class="bsf-wrap-title">
		<h2><?php echo __( 'wWw.Null24.IR - How does Ultimate Addons Work? This Plugin Shared By WwW.Null24.IR', 'ultimate_vc' ); ?></h2>
		<p><?php  _e('wWw.Null24.IR-Ultimate is built exclusively as an addon for Visual Composer Page Builder. Just some of the features it brings on the table - wWw.Null24.IR','ultimate_vc'); ?></p>
	</div><!--bsf-wrap-title-->
	
    	<div class="vc_row wpb_row vc_row-fluid bsf-grid-row bsf-grid-border-row">
            ...
            <div class="vc_col-sm-6 wpb_column vc_column_container bsf-grid-right-column-border">
			<div class="bsf-wrap-content">
            			<div class="bsf-wrap-left-icon">
		...
		<div class="vc_row wpb_row vc_row-fluid bsf-grid-row">
            <div class="vc_col-sm-6 wpb_column vc_column_container ">
				<div class="bsf-wrap-content">
					<div class="bsf-wrap-left-icon">
