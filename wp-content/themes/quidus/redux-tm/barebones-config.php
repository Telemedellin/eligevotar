<?php
    ...
    $args = array(
        ...
        'menu_title'           => __( 'Opciones generales', 'redux-framework-demo' ),
        'page_title'           => __( 'Opciones generales', 'redux-framework-demo' ),
    ...
    if ( ! isset( $args['global_variable'] ) || $args['global_variable'] !== false ) {
        ...
        $args['intro_text'] = sprintf( __( '<p>No olvide guardar sus cambios</p>', 'redux-framework-demo' ), $v );
    } else {
        $args['intro_text'] = __( '<p>No olvide guardar sus cambios</p>', 'redux-framework-demo' );
    }
    ...
    Redux::setSection( $opt_name, array(
        ...
        'id'     => 'section-header',
        'desc'   => __( 'Campo para seleccionar la imagen de fondo del cabezote', 'redux-framework-demo' ),
        'icon'   => 'el el-home',
        'fields' => array(
            array(
                'id'       => 'header-image',
    ...
    Redux::setSection( $opt_name, array(
        'title'      => __( 'Fondo', 'redux-framework-demo' ),
        'desc'       => __( 'Para cambiar el fondo del sitio web', 'redux-framework-demo' ),
        'id'         => 'section-bg',
        'icon'       => 'el el-picture',
        'fields'     => array(
            array(
  ...
  /*  Redux::setSection( $opt_name, array(
    ...
    Redux::setSection( $opt_name, array(
        'title'      => __( 'Imagen', 'redux-framework-demo' ),
        'desc'       => __( 'Selecciones la imagen para el cabezote', 'redux-framework-demo' ),
        'id'         => 'opt-header-image',
        'subsection' => false,
        'fields'     => array(
            array(
